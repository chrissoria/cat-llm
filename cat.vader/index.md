...
social media sourcing parameters for classifying posts from Reddit,
Twitter/X, YouTube, and other platforms.

`cat.vader` wraps the Python
[catvader](https://pypi.org/project/catvader/) package via
...
|----|----|
| [`classify()`](https://christophersoria.com/cat-llm/cat.vader/reference/classify.md) | Classify social media content into categories |
| [`extract()`](https://christophersoria.com/cat-llm/cat.vader/reference/extract.md) | Discover and extract categories from social media data |
| [`explore()`](https://christophersoria.com/cat-llm/cat.vader/reference/explore.md) | Get raw category extractions for saturation analysis |
