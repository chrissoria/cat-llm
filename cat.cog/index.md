...
[cat.stack](https://christophersoria.com/cat-llm/cat.stack/) that scores
CERAD constructional praxis (drawn shape) assessments using
...
|----|----|
| [`cerad_drawn_score()`](https://christophersoria.com/cat-llm/cat.cog/reference/cerad_drawn_score.md) | Score CERAD constructional praxis drawings |
