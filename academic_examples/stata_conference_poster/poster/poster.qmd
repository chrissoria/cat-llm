...
Soria (2026). *CatLLM: A Python package for generating, assigning, and scoring open-ended survey data and images.* | Soria (2026). *High agreement, different stories: how LLM classifiers reshape demographic patterns in survey data.* | Soria (2026). *Model diversity over model size: unanimous LLM ensembles correct over-classification in survey coding.* | Bojic et al. (2025). *Comparing LLM and human annotators.* | Wei et al. (2023). *Chain-of-thought prompting.* | Dhuliawala et al. (2023). *Chain-of-verification.* | Zheng et al. (2024). *Step-back prompting.*
:::
:::
