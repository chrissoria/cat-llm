"""
CatLLM brand CSS theme — mirrors the catllm.com site palette.

Dark mode with teal (primary) and orange (secondary) accents. Type pairs
IBM Plex Sans (display), DM Sans (body), and DM Mono (codes & metadata).
"""
