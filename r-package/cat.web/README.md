...
[cat.stack](../cat.stack/) that adds automatic URL fetching and web-context
prompt injection (source domain, content type, metadata).

`cat.web` wraps the Python
[catweb](https://pypi.org/project/cat-web/) package via
