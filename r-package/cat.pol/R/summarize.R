...
#'
#' @param input_data A character vector, list, or PDF/URL paths; `NULL` to
#'   fetch from a registered source.
...
#' @param tone Character. Policy-specific tone, e.g. `"eli5"`, `"neutral"`,
