...
journal and topic sourcing parameters for classifying, extracting,
exploring, and summarizing academic literature.
...
|----|----|
| [`classify()`](https://christophersoria.com/cat-llm/cat.ademic/reference/classify.md) | Classify academic papers into categories |
| [`extract()`](https://christophersoria.com/cat-llm/cat.ademic/reference/extract.md) | Discover and extract categories from paper data |
| [`explore()`](https://christophersoria.com/cat-llm/cat.ademic/reference/explore.md) | Get raw category extractions for saturation analysis |
| [`summarize()`](https://christophersoria.com/cat-llm/cat.ademic/reference/summarize.md) | Summarize academic papers |
